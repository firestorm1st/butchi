                                ...
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="" method="POST">
                                            ...
                                            <input style="border: 1px solid #000;" type="email" name="email"
                                                placeholder="email" value="{{ old('email') }}">
                                            <label style="color: red">Mật khẩu<span class="required">*</span></label>
                                            <input style="border: 1px solid #000;" type="password" name="password"
                                                placeholder="Password">
                                            <label style="color: red">Xác nhận mật khẩu<span
                                                    class="required">*</span></label>
                                            <input style="border: 1px solid #000;" type="password" class="form-control"
                                                placeholder="Enter password" name="password_confirmation">
                                            <label style="color: red">Username<span class="required">*</span></label>
                                            <input style="border: 1px solid #000;" name="username" placeholder="user_name"
                                                value="{{ old('username') }}">
